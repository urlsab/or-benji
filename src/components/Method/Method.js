            ...
            backgroundRepeat: 'no-repeat',height:'92.8vh',color:'white',width:'100%',
              ...
              filter: 'brightness(80%)'
                ...
                <div className="container">
                    <p className="methodText"> אצלנו נפגשים באווירה רגועה מול נופי רושלים, התהליך כולו מלווה ביחס אישי וחם מתוך מקצועיות ורגישות. במהלך הטיפול נעבור על מה שיעשה לכם טוב מתוך נתינת כלים להמשך החיים</p>
                </div>     
        </div> 
    );
}
